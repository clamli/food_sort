...
ga.change_parameters(theta1=60.0, theta2=62.0, theta3=1.0, theta4=3.0, theta5=100.0, theta6=100.0, theta7=15.0, theta8=10.0, theta9=80, theta10=80)
...
with open("nutrient_result_level.csv", "w", newline="") as csvfile:
	writer = csv.writer(csvfile)
	writer.writerows([row1, row2, row3, row4, row5, row6])
